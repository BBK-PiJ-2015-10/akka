...
class HashRoutingTest
  ...
  "The hashRouting" must {
    ...
    "work using mapping" in {
      ...
      val router =
        system.actorOf(ConsistentHashingPool(10,virtualNodesFactor = 10, hashMapping = hashMapping)
    ...
    "fail without using hash" in
    {
      ...
      val router =
        ...
        .props(Props(new SimpleGather(endProbe.ref))),"routerMessage")
